    ...
    if (!t.jQuery) {
        ...
        i.dequeue = function (t, e) {
            i.each(t.nodeType ? [t] : t, function (t, n) {
                ...
                a && ("fx" === e && o.unshift("inprogress"), a.call(n, function () {
                        i.dequeue(n, e)
                    }))
            })
        },
                        ...
                        if (v.State.calls[o]) {
                            ...
                            for (var g = Math.min((e - h) / d.duration, 1), y = 0, x = s.length; x > y; y++) {
                                ...
                                if (a(S)) {
                                    ...
                                    for (var T in d.visibility !== n && "hidden" !== d.visibility && b.setPropertyValue(S, "visibility", d.visibility), k)
                                        if ("element" !== T) {
                                            ...
                                            if (1 === g)
                                                ...
                                                if (M = I.startValue + A * P(g, d, A), !f && M === I.currentValue)
                                                    continue
                                            }
                                            if (I.currentValue = M, "tween" === T)
                                                m = M;
                                            else {
                                    ...
                                    d.mobileHA && a(S).transformCache.translate3d === n && (a(S).transformCache.translate3d = "(0px, 0px, 0px)", C = !0),
                ...
                var b = v.CSS = {
                    ...
                    setPropertyValue: function (t, i, n, o, r) {
                        ...
                        if ("scroll" === i)
                            ...
                            b.Normalizations.registered[i]("inject", t, n), s = "transform", n = a(t).transformCache[i];
                        else {
                            if (b.Hooks.registered[i]) {
                                var l = i,
                                c = b.Hooks.getRoot(i);
                    ...
                    function r() {
                        function t(t) {
                            function h(t, e) {
                                ...
                                o = n,
                                a = n;
                                return p.isArray(t) ? (i = t[0], !p.isArray(t[1]) && /^[\d-]/.test(t[1]) || p.isFunction(t[1]) || b.RegEx.isHex.test(t[1]) ? a = t[1] : (p.isString(t[1]) && !b.RegEx.isHex.test(t[1]) || p.isArray(t[1])) && (o = e ? t[1] : s(t[1], c.duration), t[2] !== n && (a = t[2]))) : i = t,
                                e || (o = o || c.easing),
                            ...
                            if ("scroll" === M) {
                                ...
                                for (var E in a(r).tweensContainer && !0 === a(r).isAnimating && (_ = a(r).tweensContainer), u.each(y, function (t, e) {
                                    ...
                                    if (a(r).isSVG || "tween" === z || !1 !== b.Names.prefixCheck(z)[1] || b.Normalizations.registered[z] !== n) {
                                        ...
                                        c._cacheValues && _ && _[E] ? (V === n && (V = _[E].endValue + _[E].unitType), N = a(r).rootPropertyValueCache[z]) : b.Hooks.registered[E] ? V === n ? (N = b.getPropertyValue(r, z), V = b.getPropertyValue(r, E, N)) : N = b.Hooks.templates[z][1] : V === n && (V = b.getPropertyValue(r, E));
                                        var H,
                                        j,
                                        B,
                                        Y = !1;
                                        if (V = (H = f(E, V))[0], B = H[1], $ = (H = f(E, $))[0].replace(/^([+-\/*])=/, function (t, e) {
                                                return Y = e,
                                                ""
                                            }), j = H[1], V = parseFloat(V) || 0, $ = parseFloat($) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(E) ? ($ /= 100, j = "em") : /^scale/.test(E) ? ($ /= 100, j = "") : /(Red|Green|Blue)$/i.test(E) && ($ = $ / 100 * 255, j = "")), /[\/*]/.test(Y))
                                            j = B;
                                        else if (B !== j && 0 !== V)
                                            if (0 === $)
                                                j = B;
                    ...
                    if (p.isWrapped(this) ? (d = !1, f = 0, g = this, h = this) : (d = !0, f = 1, g = k ? arguments[0].elements || arguments[0].e : arguments[0]), g = o(g)) {
                            ...
                            if (!u.isPlainObject(y) || p.isEmptyObject(y)) {
                                if (p.isString(y) && v.Redirects[y]) {
                                    ...
                                    u.each(g, function (t, e) {
                                        ...
                                        E.drag && (E.duration = parseFloat(A) || (/^(callout|transition)/.test(y) ? 1e3 : m), E.duration = Math.max(E.duration * (E.backwards ? 1 - t / S : (t + 1) / S), .75 * E.duration, 200)),
                        ...
                        if (u.each(g, function (t, e) {
                            ...
                            for (var F = 0; D > F; F++) {
                                ...
                                F === D - 1 && ($.display = E.display, $.visibility = E.visibility, $.complete = E.complete),
                                x(g, "reverse", $)
                            }
                        return t()
                    }
    ...
    ()({
        ...
        3: [function (t, e, i) {
                ...
                a.prototype = {
                    ...
                    clone: function () {
                        ...
                        o = i.values;
                        for (var r in n)
                            n.hasOwnProperty(r) && (t = n[r], "[object Array]" === (e = {}
                                    .toString.call(t)) ? o[r] = t.slice(0) : "[object Number]" === e ? o[r] = t : console.error("unexpected color value:", t));
                        return i
                    }
                },
                a.prototype.spaces = {
                ...
                a.prototype.setValues = function (t, e) {
                    ...
                    if (a.alpha = Math.max(0, Math.min(1, void 0 === l ? a.alpha : l)), "alpha" === t)
                        return !1;
                    for (i = 0; i < t.length; i++)
                        o = Math.max(0, Math.min(s[t][i], a[t][i])), a[t][i] = Math.round(o);
                    for (var u in r)
                        u !== t && (a[u] = n[t][u](a[t]));
                    return !0
                },
        ...
        4: [function (t, e, i) {
                ...
                function d(t) {
                    ...
                    o = [0, 0, 0];
                    for (var c = 0; c < 3; c++)
                        (n = r + 1 / 3 *  - (c - 1)) < 0 && n++, n > 1 && n--, a = 6 * n < 1 ? e + 6 * (i - e) * n : 2 * n < 1 ? i : 3 * n < 2 ? e + (i - e) * (2 / 3 - n) * 6 : e, o[c] = 255 * a;
                    return o
                }
                function h(t) {
                    var e = t[0] / 60,
                ...
                function y(t) {
                    ...
                    r = t[1],
                    s = t[2];
                    return a <= 8 ? o = (i = 100 * a / 903.3) / 100 * 7.787 + 16 / 116 : (i = 100 * Math.pow((a + 16) / 116, 3), o = Math.pow(i / 100, 1 / 3)),
                    ...
                    t.controllers.bar = t.DatasetController.extend({
                                ...
                                return {
                                    min: a.isNullOrUndef(i.options.barThickness) ? function (t, e) {
                                        ...
                                        for (o = 0, a = s.length; o < a; ++o)
                                            n = t.getPixelForTick(o), r = o > 0 ? Math.min(r, n - i) : r, i = n;
                                        return r
                                    }
                                    (i, c) : -1,
                                    pixels: c,
                            ...
                            calculateBarValuePixels: function (t, e) {
                                ...
                                if (p || void 0 === p && void 0 !== f)
                                    for (i = 0; i < t; ++i)
                                        (n = l.getDatasetMeta(i)).bar && n.stack === f && n.controller.getValueScaleId() === u.id && l.isDatasetVisible(i) && (o = u.getRightValue(d[i].data[e]), (h < 0 && o < 0 || h >= 0 && o > 0) && (m += o));
                    ...
                    legendCallback: function (t) {
                        ...
                        if (n.length)
                            for (var a = 0; a < n[0].data.length; ++a)
                                e.push('<li><span style="background-color:' + n[0].backgroundColor[a] + '"></span>'), o[a] && e.push(o[a]), e.push("</li>");
                        return e.push("</ul>"),
                        e.join("")
                    },
                    legend: {
                    ...
                    t.controllers.line = t.DatasetController.extend({
                            ...
                            update: function (t) {
                                ...
                                for (f && (o = l.custom || {}, void 0 !== p.tension && void 0 === p.lineTension && (p.lineTension = p.tension), l._scale = h, l._datasetIndex = r.index, l._children = c, l._model = {
                                        ...
                                        }, l.pivot()), i = 0, n = c.length; i < n; ++i)
                                    r.updateElement(c[i], i, t);
                                for (f && 0 !== l._model.tension && r.updateBezierControlPoints(), i = 0, n = c.length; i < n; ++i)
                                    c[i].pivot()
                            },
                            ...
                            updateBezierControlPoints: function () {
                                ...
                                if (o.dataset._model.spanGaps && (s = s.filter(function (t) {
                                    ...
                                    for (t = 0, e = s.length; t < e; ++t)
                                        i = s[t]._model, n = a.splineCurve(a.previousItem(s, t)._model, i, a.nextItem(s, t)._model, o.dataset._model.tension), i.controlPointPreviousX = n.previous.x, i.controlPointPreviousY = n.previous.y, i.controlPointNextX = n.next.x, i.controlPointNextY = n.next.y;
                            ...
                            draw: function () {
                                ...
                                r = n.length,
                                s = 0;
                                for (a.canvas.clipArea(t.ctx, o), e(this.getDataset(), t.options) && i.dataset.draw(), a.canvas.unclipArea(t.ctx); s < r; ++s)
                                    n[s].draw(o)
                            },
                            setHoverStyle: function (t) {
                                var e = this.chart.data.datasets[t._datasetIndex],
                    ...
                    t.animationService = {
                        ...
                        advance: function (t) {
                            for (var e, i, n = this.animations, o = 0; o < n.length; )
                                i = (e = n[o]).chart, e.currentStep = (e.currentStep || 0) + t, e.currentStep = Math.min(e.currentStep, e.numSteps), a.callback(e.render, [i, e], i), a.callback(e.onAnimationProgress, [e], i), e.currentStep >= e.numSteps ? (a.callback(e.onAnimationComplete, [e], i), i.animating = !1, n.splice(o, 1)) : ++o
                        }
                    },
                    ...
                    o.extend(t.prototype, {
                        ...
                        buildOrUpdateScales: function () {
                            ...
                            o.each(r, function (n) {
                                ...
                                if (l in a && a[l].type === c)
                                    (u = a[l]).options = r, u.ctx = i.ctx, u.chart = i;
                                else {
                        ...
                        buildOrUpdateControllers: function () {
                            ...
                            return o.each(e.data.datasets, function (o, a) {
                                ...
                                if (r.type && r.type !== s && (e.destroyDatasetMeta(a), r = e.getDatasetMeta(a)), r.type = s, i.push(r.type), r.controller)
                        ...
                        destroy: function () {
                            ...
                            a && (n.unbindEvents(), o.canvas.clear(n), s.releaseContext(n.ctx), n.canvas = null, n.ctx = null),
                            l.notify(n, "destroy"),
                        ...
                        eventHandler: function (t) {
                            ...
                            if (!1 !== l.notify(e, "beforeEvent", [t])) {
                                ...
                                return o ? e.render(o) : n && !e.animating && (e.stop(), e.render(e.options.hover.animationDuration, !0)),
                                e._bufferedRender = !1,
                                e._bufferedRequest = null,
                                e
                            }
        ...
        27: [function (t, e, i) {
                ...
                e.exports = function (t) {
                        ...
                        return a.merge(a.clone(arguments[0]), [].slice.call(arguments, 1), {
                            merger: function (e, i, n, o) {
                                if ("xAxes" === e || "yAxes" === e) {
                                    ...
                                    l,
                                    c = n[e].length;
                                    for (i[e] || (i[e] = []), r = 0; r < c; ++r)
                                        l = n[e][r], s = a.valueOrDefault(l.type, "xAxes" === e ? "category" : "linear"), r >= i[e].length && i[e].push({}), !i[e][r].type || l.type && l.type !== i[e][r].type ? a.merge(i[e][r], [t.scaleService.getScaleDefaults(s), l]) : a.merge(i[e][r], l)
                                } else
                                    a._merger(e, i, n, o)
                            }
                        })
                    ...
                    a.splineCurveMonotone = function (t) {
                        ...
                        for (e = 0; e < h - 1; ++e)
                            n = d[e], o = d[e + 1], n.model.skip || o.model.skip || (a.almostEquals(n.deltaK, 0, this.EPSILON) ? n.mK = o.mK = 0 : (r = n.mK / n.deltaK, s = o.mK / n.deltaK, (c = Math.pow(r, 2) + Math.pow(s, 2)) <= 9 || (l = 3 / Math.sqrt(c), n.mK = r * l * n.deltaK, o.mK = s * l * n.deltaK)));
                        for (e = 0; e < h; ++e)
                            (n = d[e]).model.skip || (i = e > 0 ? d[e - 1] : null, o = e < h - 1 ? d[e + 1] : null, i && !i.model.skip && (u = (n.model.x - i.model.x) / 3, n.model.controlPointPreviousX = n.model.x - u, n.model.controlPointPreviousY = n.model.y - u * n.mK), o && !o.model.skip && (u = (o.model.x - n.model.x) / 3, n.model.controlPointNextX = n.model.x + u, n.model.controlPointNextY = n.model.y + u * n.mK))
                    },
                    ...
                    a.longestText = function (t, e, i, n) {
                        ...
                        n.font !== e && (o = n.data = {}, r = n.garbageCollect = [], n.font = e),
                        t.font = e;
                        var s = 0;
                        a.each(i, function (e) {
                    ...
                    a.measureText = function (t, e, i, n, o) {
                        var a = e[o];
                        return a || (a = e[o] = t.measureText(o).width, i.push(o)),
                        a > n && (n = a),
                        n
                    },
                    ...
                    update: function (t, e, i) {
                        if (t) {
                            ...
                            n.each(h.concat(p, f, m), function (t) {
                                var e,
                                i = t.isHorizontal();
                                i ? (e = t.update(t.fullWidth ? v : k, w), S -= e.height) : (e = t.update(x, S), k -= e.width),
                                C.push({
                                    horizontal: i,
                                    minSize: e,
                                    box: t
        ...
        31: [function (t, e, i) {
                ...
                e.exports = {
                    ...
                    notify: function (t, e, i) {
                        ...
                        c = l.length;
                        for (n = 0; n < c; ++n)
                            if ("function" == typeof(s = (a = (o = l[n]).plugin)[e]) && ((r = [t].concat(i || [])).push(o.options), !1 === s.apply(a, r)))
                                return !1;
                        return !0
                    },
                    ...
                    t.Scale = o.extend({
                            ...
                            update: function (t, e, i) {
                                ...
                                for (u.beforeUpdate(), u.maxWidth = t, u.maxHeight = e, u.margins = a.extend({
                                    ...
                                    s = r[n], (c = l[n]) ? c.label = s : l.push(c = {
                                                label: s,
                                                major: !1
                                            });
                                return u._ticks = l,
                            ...
                            fit: function () {
                                ...
                                if (c.display && h) {
                                    ...
                                    if (p) {
                                        ...
                                        c.mirror ? v = 0 : v += x + b, n.width = Math.min(t.maxWidth, n.width + v), t.paddingTop = f.size / 2, t.paddingBottom = f.size / 2
                                }
                                t.handleMargins(),
                                t.width = n.width,
                                t.height = n.height
                            ...
                            _autoSkip: function (t) {
                                ...
                                p = [];
                                for (l.maxTicksLimit && (o = l.maxTicksLimit), s && (e = !1, (h + l.autoSkipPadding) * c > r.width - (r.paddingLeft + r.paddingRight) && (e = 1 + Math.floor((h + l.autoSkipPadding) * c / (r.width - (r.paddingLeft + r.paddingRight)))), o && c > o && (e = Math.max(e, Math.floor(c / o)))), i = 0; i < c; i++)
                            ...
                            draw: function (t) {
                                ...
                                if (o.display) {
                                    ...
                                    if (a.each(g, function (i, n) {
                                            if (!a.isNullOrUndef(i.label)) {
                                                ...
                                                if (m) {
                                                    ...
                                                    var N,
                                                    H = "left" === o.position;
                                                    u.mirror ? (F = H ? "left" : "right", N = W) : (F = H ? "right" : "left", N = w + W),
                                            ...
                                            R = r(p) / 2;
                                            if (m)
                                                D = e.left + (e.right - e.left) / 2, E = "bottom" === o.position ? e.bottom - R - C.bottom : e.top + R + C.top;
                                            else {
                                    ...
                                    if (h.drawBorder) {
                                        ...
                                        m ? (V = z = "top" === o.position ? e.bottom : e.top, V += N, z += N) : ($ = W = "left" === o.position ? e.right : e.left, $ += N, W += N),
                                        s.beginPath(),
                                        s.moveTo($, V),
                                        s.lineTo(W, z),
                                        s.stroke()
                ...
                e.exports = function (t) {
                    ...
                    t.Tooltip = o.extend({
                            ...
                            update: function (e) {
                                ...
                                if (m.length) {
                                    ...
                                    for (i = 0, n = m.length; i < n; ++i)
                                        S.push((o = m[i], s = void 0, l = void 0, void 0, void 0, s = o._xScale, l = o._yScale || o._scale, c = o._index, u = o._datasetIndex, {
                                    ...
                                    y = function (t, e, i, n) {
                                        ...
                                        d = r + s,
                                        h = l + s;
                                        return "right" === c ? o -= e.width : "center" === c && ((o -= e.width / 2) + e.width > n.width && (o = n.width - e.width), o < 0 && (o = 0)),
                            ...
                            getCaretPosition: function (t, e, i) {
                                ...
                                g = e.height;
                                if ("center" === h)
                                    s = f + g / 2, "left" === d ? (o = (n = p) - c, a = n, r = s + c, l = s - c) : (o = (n = p + m) + c, a = n, r = s - c, l = s + c);
                            ...
                            drawTitle: function (t, i, n, o) {
                                ...
                                if (r.length) {
                                    ...
                                    c = i.titleFontSize,
                                    u = i.titleSpacing;
                                    for (n.fillStyle = e(i.titleFontColor, o), n.font = a.fontString(c, i._titleFontStyle, i._titleFontFamily), s = 0, l = r.length; s < l; ++s)
                                        n.fillText(r[s], t.x, t.y), t.y += c + u, s + 1 === r.length && (t.y += i.titleMarginBottom - u)
                                }
                            },
                            drawBody: function (t, i, n, o) {
                                ...
                                a.each(l, function (s, l) {
                                    ...
                                    a.each(s.lines, function (a) {
                                        d && (n.fillStyle = e(i.legendColorBackground, o), n.fillRect(t.x, t.y, r, r), n.lineWidth = 1, n.strokeStyle = e(i.labelColors[l].borderColor, o), n.strokeRect(t.x, t.y, r, r), n.fillStyle = e(i.labelColors[l].backgroundColor, o), n.fillRect(t.x + 1, t.y + 1, r - 2, r - 2), n.fillStyle = c),
                                        u(a)
                                    }),
                                    a.each(s.after, u)
                                }),
                            ...
                            handleEvent: function (t) {
                                ...
                                (e = !a.arrayEquals(i._active, i._lastActive)) && (i._lastActive = i._active, (n.enabled || n.custom) && (i._eventPosition = {
                                            x: t.x,
                                            y: t.y
                                        }, i.update(!0), i.pivot())),
                                e
        ...
        37: [function (t, e, i) {
                ...
                e.exports = o.extend({
                        draw: function () {
                            ...
                            u = r.elements.line,
                            d = -1;
                            for (this._loop && c.length && c.push(c[0]), s.save(), s.lineCap = o.borderCapStyle || u.borderCapStyle, s.setLineDash && s.setLineDash(o.borderDash || u.borderDash), s.lineDashOffset = o.borderDashOffset || u.borderDashOffset, s.lineJoin = o.borderJoinStyle || u.borderJoinStyle, s.lineWidth = o.borderWidth || u.borderWidth, s.strokeStyle = o.borderColor || r.defaultColor, s.beginPath(), d = -1, t = 0; t < c.length; ++t)
                                e = c[t], i = a.previousItem(c, t), n = e._view, 0 === t ? n.skip || (s.moveTo(n.x, n.y), d = t) : (i = -1 === d ? i : c[d], n.skip || (d !== t - 1 && !l || -1 === d ? s.moveTo(n.x, n.y) : a.canvas.lineTo(s, i._view, e._view), d = t));
                            s.stroke(),
                            s.restore()
                        }
                    })
        ...
        44: [function (t, e, i) {
                ...
                e.exports = {
                    ...
                    resolve: function (t, e, i) {
                        ...
                        r;
                        for (o = 0, a = t.length; o < a; ++o)
                            if (void 0 !== (r = t[o]) && (void 0 !== e && "function" == typeof r && (r = r(e)), void 0 !== i && n.isArray(r) && (r = r[i]), void 0 !== r))
                                return r
                    }
                }
            }, {
        ...
        47: [function (t, e, i) {
                ...
                function m(t, e, i) {
                    ...
                    ((c = function () {
                            ...
                            u = u || this,
                            d || (d = !0, n.requestAnimFrame.call(window, function () {
                                    d = !1,
                                    c.apply(u, p)
                                }))
                        }));
        ...
        50: [function (t, e, i) {
                ...
                e.exports = {
                    ...
                    afterDatasetsUpdate: function (t, e) {
                        ...
                        p = [];
                        for (n = 0; n < d; ++n)
                            r = null, (a = (i = t.getDatasetMeta(n)).dataset) && a._model && a instanceof o.Line && (r = {
                        ...
                        for (n = 0; n < d; ++n)
                            (r = p[n]) && (r.fill = c(p, n, h), r.boundary = l(r), r.mapper = u(r))
                    },
                        ...
                        if (i) {
                            ...
                            c && u && l.length && (a.canvas.clipArea(o, t.chartArea), function (t, e, i, n, o, a) {
                                ...
                                for (t.beginPath(), r = 0, s = m + !!a; r < s; ++r)
                                    u = i(c = e[l = r % m]._view, l, n), p = d(c), f = d(u), p && f ? (b = v.push(c), x = y.push(u)) : b && x && (g ? (p && v.push(c), f && y.push(u)) : (h(t, v, y, b, x), b = x = 0, v = [], y = []));
                                h(t, v, y, b, x),
                                t.closePath(),
                                t.fillStyle = o,
                                t.fill()
                            ...
                            if (g ? (m.width = t.maxWidth, m.height = o ? 10 : 0) : (m.width = o ? 10 : 0, m.height = t.maxHeight), o)
                                if (r.font = p, g) {
                                    ...
                                    a.each(t.legendItems, function (e, n) {
                                        ...
                                        v[v.length - 1] + o + i.padding >= t.width && (y += u + i.padding, v[v.length] = t.left),
                                        f[n] = {
                                            left: 0,
                                            top: 0,
                                            width: o,
                                    ...
                                    a.each(t.legendItems, function (t, e) {
                                        ...
                                        S + C > m.height && (w += k + i.padding, x.push(k), k = 0, S = 0),
                                        k = Math.max(k, n),
                                        S += C,
                                        f[e] = {
                                            left: 0,
                                    ...
                                    function (t, i, n) {
                                        if (!(isNaN(y) || y <= 0)) {
                                            ...
                                            if (d.setLineDash && d.setLineDash(h(n.lineDash, r.borderDash)), e.labels && e.labels.usePointStyle) {
                                                ...
                                                s || d.strokeRect(t, i, y, f), d.fillRect(t, i, y, f);
                                            d.restore()
                                        }
                                    }
                                    (g, v, n),
                ...
                var l = o.extend({
                        ...
                        draw: function () {
                            ...
                            if (o.display) {
                                ...
                                e.font = p,
                                t.isHorizontal() ? (l = y + (x - y) / 2, c = v + m, s = x - y) : (l = "left" === o.position ? y + m : x - m, c = v + (b - v) / 2, s = b - v, g = Math.PI * ("left" === o.position ?  - .5 : .5)),
                                e.save(),
                                e.translate(l, c),
                                e.rotate(g),
                                e.textAlign = "center",
                    ...
                    t.LinearScaleBase = t.Scale.extend({
                            ...
                            buildTicks: function () {
                                ...
                                a = t.ticks = function (t, e) {
                                    ...
                                    var c = 1;
                                    i < 1 && (c = Math.pow(10, i.toString().length - 2), r = Math.round(r * c) / c, s = Math.round(s * c) / c),
                                            ...
                                            if (n.display && 0 !== s && function (t, e, i, n) {
                                                ...
                                                if (a.strokeStyle = o.valueAtIndexOrDefault(e.color, n - 1), a.lineWidth = o.valueAtIndexOrDefault(e.lineWidth, n - 1), t.options.gridLines.circular)
                                                    a.beginPath() , a.arc(t.xCenter, t.yCenter, i, 0, 2 * Math.PI), a.closePath(), a.stroke();
                                                        ...
                                                        a.moveTo(l.x, l.y);
                                                        for (var c = 1; c < s; c++)
                                                            l = t.getPointPosition(c, i), a.lineTo(l.x, l.y);
                                                        a.closePath(),
                                                        a.stroke()
                                                    }
                                                }
                ...
                function g(t, e, i, o) {
                    ...
                    d = u.unit || function (t, e, i, n) {
                        ...
                        for (o = c.indexOf(t); o < u - 1; ++o)
                            if (r = (a = l[c[o]]).steps ? a.steps[a.steps.length - 1] : s, a.common && Math.ceil((i - e) / (r * a.size)) <= n)
                                return c[o];
                        return c[u - 1]
                    }
                    (u.minUnit, t, e, i),
                ...
                e.exports = function (t) {
                    var e = t.Scale.extend({
                            ...
                            determineDataLimits: function () {
                                ...
                                x = [],
                                w = [];
                                for (t = 0, i = p.data.labels.length; t < i; ++t)
                                ...
                                for (t = 0, i = (p.data.datasets || []).length; t < i; ++t)
                                    if (p.isDatasetVisible(t))
                                        if (l = p.data.datasets[t].data, a.isObject(l[0]))
                                            for (x[t] = [], e = 0, o = l.length; e < o; ++e)
                                                c = f(l[e], h), b.push(c), x[t][e] = c;
                                        else
                                            b.push.apply(b, w), x[t] = w.slice(0);
                                    else
                                        x[t] = [];
                                w.length && (w = d(w).sort(u), v = Math.min(v, w[0]), y = Math.max(y, w[w.length - 1])),
                                b.length && (b = d(b).sort(u), v = Math.min(v, b[0]), y = Math.max(y, b[b.length - 1])),
                                v = f(m.min, h) || v,
                                y = f(m.max, h) || y,
                                v = v === s ? +n().startOf(g) : v,
                                y = y === r ? +n().endOf(g) + 1 : y,
                            ...
                            buildTicks: function () {
                                ...
                                for ("ticks" === s.bounds && d.length && (a = d[0], r = d[d.length - 1]), a = f(u.min, o) || a, r = f(u.max, o) || r, t = 0, e = d.length; t < e; ++t)
                                ...
                                o._unit = u.unit || function (t, e, i, o) {
                                    ...
                                    for (a = c.length - 1; a >= c.indexOf(e); a--)
                                        if (r = c[a], l[r].common && s.as(r) >= t.length)
                                            return r;
                                ...
                                o._table = function (t, e, i, n) {
                                    ...
                                    for (u.push(i), o = 0, a = u.length; o < a; ++o)
                                        l = u[o + 1], r = u[o - 1], s = u[o], void 0 !== r && void 0 !== l && Math.round((l + r) / 2) === s || c.push({
                                            time: s,
                                            pos: o / (a - 1)
                                        });
                                    return c
                                ...
                                function (t, e) {
                                    ...
                                    for (i = 0, o = t.length; i < o; ++i)
                                        a = t[i], r = !!e && a === +n(a).startOf(e), s.push({
                                            value: a,
                                            major: r
                                        });
                                    return s
                            ...
                            getPixelForValue: function (t, e, i) {
                                var n = null;
                                if (void 0 !== e && void 0 !== i && (n = this._timestamps.datasets[i][e]), null === n && (n = f(t, this)), null !== n)
...
("object" == typeof global ? global : this, function () {
    ...
    var l = {
        ...
        show: function (t, e, i) {
            ...
            a = 0,
            c = 0;
            "touches" in t && t.touches.length ? (a = t.touches[0].pageY - o.top, c = t.touches[0].pageX - o.left) : (a = t.pageY - o.top, c = t.pageX - o.left),
            c = c >= 0 ? c : 0,
            a = a >= 0 ? a : 0;
...
var _this = this;
(t => {
    const e = `${["text","password","email","url","tel","number","search","search-md"].map(t=>` input[type = $ {
                t
            }
        ]`).join(", ")}, textarea`,
    i = t => {
        ...
        return function () {
            ...
            function u(i) {
                ...
                if (void 0 !== i.optionsOverride && (a = t.extend(a, i.optionsOverride), r = i.optionsOverride.iconClass || r), !function (t, e) {
                    ...
                    a.closeButton && (g.addClass("toast-close-button").attr("role", "button"), u.prepend(g)),
                    a.progressBar && (m.addClass("toast-progress"), u.prepend(m)),
                ...
                function b(e) {
                    if (!t(":focus", u).length || e)
                        return clearTimeout(v.intervalId), u[a.hideMethod]({
            ...
            function h(t) {
                e || (e = s()),
                t.is(":visible") || (t.remove(), t = null, 0 === e.children().length && (e.remove(), n = void 0))
            }
        }
        ()
    })
    ...
    t.fn.dropdown = function (e) {
        this.each(function () {
            ...
            function s(e) {
                ...
                if (!g.is("body") && g[0].scrollHeight > g[0].clientHeight && (m = g[0].scrollTop), c + a.innerWidth() > t(window).width() ? d = "right" : c - a.innerWidth() + i.innerWidth() < 0 && (d = "left"), u + a.innerHeight() > s)
                    if (u + l - a.innerHeight() < 0) {
                        ...
                        f || (f += l), f -= a.innerHeight();
                if ("left" === d)
                    h = n.gutter, p = i.position().left + h;
                else if ("right" === d) {
            ...
            if (r(), i.after(a), n.hover) {
                ...
                i.unbind(`click.${i.attr("id")}`), i.bind(`click.${i.attr("id")}`, e => {
...
dropdownSelectors.on({
    ...
    const e = t => {
        ...
        if (!e.hasClass("active")) {
            e.addClass("active"),
            document.querySelectorAll("ul .btn-floating").forEach(t => {
...
(jQuery), function (t, e, i, n) {
    ...
    function K(t, e, i) {
        ...
        function (t, e) {
            ...
            e.scale = s ? (p = s.pointers, f = o, it(f[0], f[1], Q) / it(p[0], p[1], Q)) : 1,
            ...
            function (t, e) {
                ...
                if (e.eventType != V && (l > R || s.velocity === n)) {
                    ...
                    i = s.velocity, o = s.velocityX, a = s.velocityY, r = s.direction;
                e.velocity = i,
                e.velocityX = o,
                e.velocityY = a,
                e.direction = r
    ...
    v(st, Z, {
        handler: function (t) {
            ...
            e & $ && 1 !== t.which && (e = W),
            this.pressed && (e & W && (this.pressed = !1), this.callback(this.manager, e, {
                    pointers: [t],
                    changedPointers: [t],
                    pointerType: "mouse",
                    srcEvent: t
    ...
    t.MSPointerEvent && !t.PointerEvent && (ut = "MSPointerDown", dt = "MSPointerMove MSPointerUp MSPointerCancel"),
    v(ht, Z, {
        handler: function (t) {
            var e = this.store,
            i = !1,
            ...
            o & F && (0 === t.button || r) ? s < 0 && (e.push(t), s = e.length - 1) : o & (W | V) && (i = !0),
            s < 0 || (e[s] = t, this.callback(this.manager, o, {
                    pointers: e,
                    changedPointers: [t],
                    pointerType: a,
                    srcEvent: t
    ...
    v(bt, Z, {
        handler: function (t) {
            ...
            i = function (t, e) {
                ...
                o = 0;
                for (; o < r.length; )
                    n[r[o].identifier] && s.push(r[o]), e & (W | V) && delete n[r[o].identifier], o++;
                if (!s.length)
                    return;
    ...
    Dt.prototype = {
        ...
        preventDefaults: function (t) {
            ...
            if (this.manager.session.prevented)
                ...
                if (!r || !a)
                    return o || a && i & Y || r && i & X ? this.preventSrc(e) : void 0
            }
        },
    ...
    Vt.prototype = {
        ...
        recognizeWith: function (t) {
            ...
            return e[(t = Ht(t, this)).id] || (e[t.id] = t, t.recognizeWith(this)),
            this
        },
        ...
        requireFailure: function (t) {
            ...
            return -1 === M(e, t = Ht(t, this)) && (e.push(t), t.requireFailure(this)),
            this
        },
    ...
    v(Bt, jt, {
        ...
        directionTest: function (t) {
            ...
            a = t.deltaX,
            r = t.deltaY;
            return o & e.direction || (e.direction & Y ? (o = 0 === a ? z : a < 0 ? N : H, i = a != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === r ? z : r < 0 ? j : B, i = r != this.pY, n = Math.abs(t.deltaY))),
            t.direction = o,
    ...
    v(Xt, Vt, {
        ...
        process: function (t) {
            ...
            if (this._input = t, !n || !i || t.eventType & (W | V) && !o)
                this.reset();
    ...
    v(Ut, jt, {
        ...
        attrTest: function (t) {
            ...
            return i & (Y | X) ? e = t.overallVelocity : i & Y ? e = t.overallVelocityX : i & X && (e = t.overallVelocityY),
    ...
    function Gt(t, e) {
        ...
        n.style && (p(t.options.cssProps, function (o, a) {
                i = A(n.style, a),
                e ? (t.oldCssProps[i] = n.style[i], n.style[i] = o) : n.style[i] = t.oldCssProps[i] || ""
            }), e || (t.oldCssProps = {}))
    }
    Kt.prototype = {
        set: function (t) {
        ...
        recognize: function (t) {
            ...
            if (!e.stopped) {
                ...
                for (var a = 0; a < n.length; )
                    i = n[a], 2 === e.stopped || o && i != o && !i.canRecognizeWith(o) ? i.reset() : i.recognize(t), !o && i.state & (Lt | Rt | Ft) && (o = e.curRecognizer = i), a++
            }
        },
        get: function (t) {
            if (t instanceof Vt)
...
(function (t, e) {
        ...
        return this.each(function () {
            new class {
                ...
                panendEventHandler(t) {
                    ...
                    c > 0 && (c = 0),
                    u < 0 && (u = 0),
                    "left" === this.options.edge ? (this.menuOut && e <= o || e < a ? (0 !== c && this.translateMenuX([0, c], "300"), this.showSidenavOverlay()) : (!this.menuOut || e > o) && (this.enableScrolling(), this.translateMenuX([-1 * this.options.MENU_WIDTH - l, c], "200"), this.hideSidenavOverlay()), this.$dragTarget.css({
                            width: "10px",
                            right: "",
                            left: 0
                ...
                openOnClick() {
                    this.$element.on("click", e => {
                        if (e.preventDefault(), !0 === this.menuOut)
                            this.menuOut = !1, this.removeMenu();
                        else {
                            this.$sidenavOverlay = t('<div id="sidenav-overlay"></div>'),
                            this.$body.append(this.$sidenavOverlay);
                            let e = [];
                            e = "left" === this.options.edge ? [0, -1 * this.options.MENU_WIDTH] : [0, this.options.MENU_WIDTH],
                            this.$menu.velocity({
                                translateX: e
                            }, {
                                duration: 300,
                ...
                setMenuTranslation() {
                    ...
                    this.$menu.hasClass("fixed") && (window.innerWidth > i && this.$menu.css("transform", "translateX(0)"), t(window).resize(() => {
                            if (window.innerWidth > i)
                                this.$sidenavOverlay.length ? this.removeMenu(!0) : this.$menu.css("transform", "translateX(0%)");
    ...
    t.fn.collapsible = function (e) {
        ...
        this.each(function () {
            ...
            e.accordion || "accordion" === l || void 0 === l ? ((s = i.find("> li > .collapsible-header")).on("click.collapse", e => {
                    let o = t(e.target);
                    a(o) && (o = r(o)),
...
(0, function (t) {
    var e = function (t, e) {
        ...
        c = function () {
            e.scaleColor && function () {
                ...
                o.save();
                for (var n = 24; n > 0; --n)
                    n % 6 == 0 ? (i = e.scaleLength, t = 0) : (i = .6 * e.scaleLength, t = e.scaleLength - i), o.fillRect(-e.size / 2 + t, 0, i, 1), o.rotate(Math.PI / 12);
                o.restore()
            }
            (),
    ...
    t(document).on("input mousedown touchstart", e, function (o) {
        ...
        if (!r.length && function () {
            ...
            (i = e ? o.originalEvent.touches[0].pageX - t(this).offset().left : o.pageX - t(this).offset().left) < 0 ? i = 0 : i > s && (i = s),
    ...
    class e {
        ...
        renderMaterialSelect() {
            if (this.$nativeSelect.before(this.$selectWrapper), this.appendDropdownIcon(), this.appendMaterialSelect(), this.appendMaterialOptionsList(), this.appendNativeSelect(), this.appendSaveSelectButton(), this.$nativeSelect.is(":disabled") || this.$materialSelect.dropdown({
                    hover: !1,
                    closeOnClick: !1
                }), !1 !== this.$nativeSelect.data("inherit-tabindex") && this.$materialSelect.attr("tabindex", this.$nativeSelect.attr("tabindex")), this.isMultiple)
                this.$nativeSelect.find("option:selected:not(:disabled)").each((e, i) => {
                    const n = t(i).index();
                    this._toggleSelectedValue(n),
                    this.$materialOptionsList.find("li:not(.optgroup):not(.select-toggle-all)").eq(n).find(":checkbox").prop("checked", !0)
                });
            else {
        ...
        buildMaterialOptions() {
            this.$nativeSelectChildren.each((e, i) => {
                const n = t(i);
                if (n.is("option"))
                    this.buildSingleOption(n, this.isMultiple ? "multiple" : "");
                else if (n.is("optgroup")) {
                    const e = t(`<li class="optgroup"><span>${n.attr("label")}</span></li>`);
                    this.$materialOptionsList.append(e),
                    n.children("option").each((e, i) => {
        ...
        bindEvents() {
            ...
            this.$materialOptionsList.find("li:not(.optgroup)").not(this.$toggleAll).each((e, i) => {
        ...
        _onEachMaterialOptionClick(e, i, n) {
            ...
            if (this.isMultiple) {
                ...
                this.$materialOptionsList.find("li").removeClass("active"), o.toggleClass("active"), this.$materialSelect.val(o.text()), this.$materialSelect.trigger("close");
        ...
        _onToggleAllClick() {
            ...
            i = !t(e).prop("checked");
            t(e).prop("checked", i),
            this.$materialOptionsList.find("li:not(.optgroup):not(.disabled):not(.select-toggle-all)").each((e, n) => {
...
(function (t) {
    ...
    function a(e, l, u, d) {
        ...
        y = v.prototype = {
            ...
            render: function (e) {
                return e ? (y.$holder = t(b()), x(), y.$root.html(y.$holder)) : y.$root.find("." + m.box).html(y.component.nodes(p.open)),
                y.trigger("render")
            },
            stop: function () {
            ...
            on: function (e, i, n) {
                ...
                if (e)
                    for (o in r || (s[e] = i), s)
                        a = s[o], n && (o = "_" + o), p.methods[o] = p.methods[o] || [], p.methods[o].push(a);
                return y
            },
            off: function () {
                var t,
    ...
    a._ = {
        ...
        isDate: function (t) {
            return {}
            .toString.call(t).indexOf("Date") > -1 && this.isInteger(t.getDate())
        },
...
(function (t, e) {
    ...
    o.prototype.validate = function (t, i, o) {
        ...
        if ((!o || !o.nav && !o.defaultValue) && (!h && c.disabled(i) || h && c.disabled(i) && (m || a || r) || !h && (i.pick <= p.pick || i.pick >= f.pick)))
            for (h && !m && (!r && d > 0 || !a && d < 0) && (d *= -1); c.disabled(i) && (Math.abs(d) > 1 && (i.month < u.month || i.month > u.month) && (i = u, d = d > 0 ? 1 : -1), i.pick <= p.pick ? (s = !0, d = 1, i = c.create([p.year, p.month, p.date + (i.pick === p.pick ? 0 : -1)])) : i.pick >= f.pick && (l = !0, d = -1, i = c.create([f.year, f.month, f.date + (i.pick === f.pick ? 0 : 1)])), !s || !l); )
    ...
    function C(t, e) {
        ...
        L,
        R,
        F = n('<div class="clockpicker-tick"></div>');
        if (e.twelvehour)
            for (D = 0; D < 12; D += e.hourstep)
                E = F.clone(), L = D / 6 * Math.PI, R = y, E.css("font-size", "140%"), E.css({
        ...
        for (D = 0; D < 60; D += W)
            for (D = 0; D < 60; D += 5)
                E = F.clone(), L = D / 30 * Math.PI, E.css({
        ...
        function V(t, i) {
            ...
            if (!i || !(f < y - x || f > y + x)) {
                ...
                a.off(h).on(h, function (t) {
                    ...
                    "hours" === _.currentView ? _.toggleView("minutes", k / 2) : e.autoclose && (_.minutesView.addClass("clockpicker-dial-out"), setTimeout(function () {
                            _.done()
                        }, k / 2)),
                    l.prepend(z),
                    clearTimeout(g),
    ...
    C.prototype.show = function (t) {
        if (!this.isShown) {
            ...
            this.isAppended || (this.popover.insertAfter(this.input), this.options.twelvehour && (this.amOrPm = "PM", this.options.ampmclickable ? (this.spanAmPm.children("#click-pm").addClass("text-primary"), this.spanAmPm.children("#click-am").removeClass("text-primary")) : (this.amPmBlock.children(".am-button").removeClass("active"), this.amPmBlock.children(".pm-button").addClass("active"), this.spanAmPm.empty().append("PM"))), o.on("resize.clockpicker" + this.id, function () {
                    e.isShown && e.locate()
                }), this.isAppended = !0),
...
(this, function () {
    ...
    return function (t, e, i, n) {
        ...
        Rt = null,
        Ft = function () {
            Rt && (o.unbind(document, "mousemove", Ft), o.addClass(t, "pswp--has_mouse"), r.mouseUsed = !0, Ct("mouseUsed")),
        ...
        Zt = {
            ...
            init: function () {
                if (!s && !l) {
                    ...
                    for ($.animationName && $.transform && !n || (r.showAnimationDuration = r.hideAnimationDuration = 0), i = 0; i < vt.length; i++)
                        a["init" + vt[i]]();
                    ...
                    void 0 === F && (Ct("initialLayout"), F = L = o.getScrollY());
                    var c = "pswp--open ";
                    for (r.mainClass && (c += r.mainClass + " "), r.showHideOpacity && (c += "pswp--animate_opacity "), c += _ ? "pswp--touch" : "pswp--notouch", c += $.animationName ? " pswp--css_animation" : "", c += $.svg ? " pswp--svg" : "", o.addClass(t, c), a.updateSize(), h = -1, mt = null, i = 0; 3 > i; i++)
            ...
            updateCurrItem: function (t) {
                if (0 !== mt) {
                    ...
                    if (!(t && 2 > i)) {
                        ...
                        for (var n = 0; i > n; n++)
                            mt > 0 ? (e = k.shift(), k[2] = e, _t((++h + 2) * ft.x, e.el.style), a.setContent(e, u - i + n + 1 + 1)) : (e = k.pop(), k.unshift(e), _t(--h * ft.x, e.el.style), a.setContent(e, u + i - n - 1 - 1));
                        if (tt && 1 === Math.abs(mt)) {
                            var o = Ve(S);
            ...
            updateSize: function (e) {
                if (!gt && r.modal) {
                    var i = o.getScrollY();
                    if (F !== i && (t.style.top = i + "px", F = i), !e && yt.x === window.innerWidth && yt.y === window.innerHeight)
                        return;
                ...
                if (dt.x = a.scrollWrap.clientWidth, dt.y = a.scrollWrap.clientHeight, jt(), ft.x = dt.x + Math.round(dt.x * r.spacing), ft.y = dt.y, Ot(ft.x * ht), Ct("beforeResize"), void 0 !== h) {
                    for (var n, s, l, c = 0; 3 > c; c++)
                        n = k[c], _t((c + h) * ft.x, n.el.style), l = u + c - 1, r.loop && ze() > 2 && (l = wt(l)), (s = Ve(l)) && (w || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(n, l), 1 === c && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === n.index && l >= 0 && a.setContent(n, l), s && s.container && (Ye(s, dt), Qe(s), At(s));
                    w = !1
                }
                v = g = a.currItem.initialZoomLevel,
                (J = a.currItem.bounds) && (ut.x = J.center.x, ut.y = J.center.y, Pt(!0)),
                Ct("resize")
            },
            zoomTo: function (t, e, i, n, a) {
                ...
                Lt(s);
                var d = function (e) {
                    1 === e ? (g = t, ut.x = s.x, ut.y = s.y) : (g = (t - l) * e + l, ut.x = (s.x - c) * e + c, ut.y = (s.y - u) * e + u),
                    a && a(e),
                    Pt(1 === e)
                };
        ...
        Ce = function (t) {
            ...
            return A ? (st = 0, ie.forEach(function (t) {
                    ...
                    st++
                })) : t.type.indexOf("touch") > -1 ? t.touches && t.touches.length > 0 && (Se[0] = ye(t.touches[0], we), t.touches.length > 1 && (Se[1] = ye(t.touches[1], ke))) : (we.x = t.pageX, we.y = t.pageY, we.id = "", Se[0] = we),
            Se
        },
        Te = function (t, e) {
            var i,
            ...
            l = ut[t] + e[t] * i,
            !r.allowPanToNext && g !== a.currItem.initialZoomLevel || (tt ? "h" !== it || "x" !== t || X || (c ? (l > J.min[t] && (i = r.panEndFriction, J.min[t], n = J.min[t] - ct[t]), (0 >= n || 0 > d) && ze() > 1 ? (s = u, 0 > d && u > ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l)) : (l < J.max[t] && (i = r.panEndFriction, J.max[t], n = ct[t] - J.max[t]), (0 >= n || d > 0) && ze() > 1 ? (s = u, d > 0 && u < ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l))) : s = u, "x" !== t) ? void(et || Q || g > a.currItem.fitRatio && (ut[t] += e[t] * i)) : (void 0 !== s && (Ot(s, !0), Q = s !== ne.x), J.min.x !== J.max.x && (void 0 !== o ? ut.x = o : Q || (ut.x += e.x * i)), void 0 !== s)
        },
        Me = function (t) {
            if (!("mousedown" === t.type && t.button > 0)) {
                ...
                if (!j || "mousedown" !== t.type) {
                    ...
                    Z = null,
                    Ut(),
                    B && 1 !== n || (B = nt = !0, o.bind(window, p, a), N = rt = ot = H = Q = q = Y = X = !1, it = null, Ct("firstTouchStart", i), Et(ct, ut), lt.x = lt.y = 0, Et(te, i[0]), Et(ee, te), ne.x = ft.x * ht, oe = [{
                                x: te.x,
                                y: te.y
                            }
                        ], V = W = Tt(), $t(g, !0), pe(), fe()),
                    !K && n > 1 && !et && !Q && (v = g, X = !1, K = Y = !0, lt.y = lt.x = 0, Et(ct, ut), Et(Kt, i[0]), Et(Gt, i[1]), be(Kt, Gt, de), ue.x = Math.abs(de.x) - ut.x, ue.y = Math.abs(de.y) - ut.y, G = he(Kt, Gt))
                }
            }
        },
        Ie = function (t) {
            ...
            if (Z) {
                ...
                if (0 !== t)
                    if (Et(Kt, Z[0]), Jt.x = Kt.x - te.x, Jt.y = Kt.y - te.y, K && t > 1) {
                        ...
                        if (!it)
                            return;
                        if (nt && (nt = !1, Math.abs(Jt.x) >= 10 && (Jt.x -= Z[0].x - ee.x), Math.abs(Jt.y) >= 10 && (Jt.y -= Z[0].y - ee.y)), te.x = Kt.x, te.y = Kt.y, 0 === Jt.x && 0 === Jt.y)
                            return;
        ...
        _e = function () {
            ...
            i = {
                ...
                calculateSwipeSpeed: function (n) {
                    oe.length > 1 ? (t = Tt() - V + 50, e = oe[oe.length - 2][n]) : (t = Tt() - W, e = ee[n]),
        ...
        De = function (t, e) {
            ...
            h = ft.x * ht,
            p = Math.abs(h - ce.x);
            return i || h > ce.x == e.lastFlickSpeed.x > 0 ? (d = Math.abs(e.lastFlickSpeed.x) > 0 ? p / Math.abs(e.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333,
            re === u && (i = !1),
            et = !0,
        ...
        xt("Gestures", {
            publicMethods: {
                initGestures: function () {
                    ...
                    A ? navigator.pointerEnabled ? t("pointer", "down", "move", "up", "cancel") : t("MSPointer", "Down", "Move", "Up", "Cancel") : $.touch ? (t("touch", "start", "move", "end", "cancel"), _ = !0) : t("mouse", "down", "move", "up"),
                    p = T + " " + M + " " + I,
                    f = C,
                    ...
                    m[M] = Ae,
                    I && (m[I] = m[M]),
                    $.touch && (f += " mousedown", p += " mousemove mouseup", m.mousedown = m[C], m.mousemove = m[T], m.mouseup = m[M]),
        ...
        Ne = function (e, i, n, s) {
            ...
            h = function () {
                Xt("initialZoom"),
                n ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (Mt(1), i && (i.style.display = "block"), o.addClass(t, "pswp--animated-in"), Ct("initialZoom" + (n ? "OutEnd" : "InEnd"))),
                s && s(),
                We = !1
            };
            if (!d || !l || void 0 === l.x)
                return Ct("initialZoom" + (n ? "Out" : "In")), g = e.initialZoomLevel, Et(ut, e.initialPosition), Pt(), t.style.opacity = n ? 0 : 1, Mt(1), void(d ? setTimeout(function () {
                        h()
                    }, d) : h());
            !function () {
                var i = c,
                ...
                n || (g = l.w / e.w, ut.x = l.x, ut.y = l.y - L, a[s ? "template" : "bg"].style.opacity = .001, Pt()),
                qt("initialZoom"),
                ...
                Re = setTimeout(function () {
                        if (Ct("initialZoom" + (n ? "Out" : "In")), n) {
                            ...
                            g = e.initialZoomLevel, Et(ut, e.initialPosition), Pt(), Mt(1), s ? t.style.opacity = 1 : Mt(1), Re = setTimeout(h, d + 20)
                    }, n ? 25 : 90)
            }
            ()
        },
                        ...
                        if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ue(l), Ye(l, dt), !l.src || l.loadError || l.loaded)
                            ...
                            if (l.loadComplete = function (i) {
                                if (s) {
                                    if (t && t.index === e) {
                                        if (Ue(i, !0))
                                            return i.loadComplete = i.img = null, Ye(i, dt) , At(i), void(t.index === u && a.updateCurrZoomItem());
            ...
            publicMethods: {
                ...
                handleMouseWheel: function (t) {
                    if (g <= a.currItem.fitRatio)
                        return r.modal && (!r.closeOnScroll || Yt || B ? t.preventDefault() : P && Math.abs(t.deltaY) > 2 && (c = !0, a.close())), !0;
                    if (t.stopPropagation(), Ge.x = 0, "deltaX" in t)
                        1 === t.deltaMode ? (Ge.x = 18 * t.deltaX, Ge.y = 18 * t.deltaY) : (Ge.x = t.deltaX, Ge.y = t.deltaY);
                    else if ("wheelDelta" in t)
                        t.wheelDeltaX && (Ge.x =  - .16 * t.wheelDeltaX), t.wheelDeltaY ? Ge.y =  - .16 * t.wheelDeltaY : Ge.y =  - .16 * t.wheelDelta;
                    else {
                        if (!("detail" in t))
                            return;
                        Ge.y = t.detail
...
(this, function () {
    ...
    return function (t, e) {
        ...
        O = function (e) {
            ...
            !(!i.href || !i.hasAttribute("download") && (window.open(i.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), S || _(), 1))
        },
        D = function () {
            for (var t, e, i, n, o = "", a = 0; a < g.shareButtons.length; a++)
                t = g.shareButtons[a], e = g.getImageURLForShare(t), i = g.getPageURLForShare(t), n = g.getTextForShare(t), o += '<a href="' + t.url.replace("{{url}}", encodeURIComponent(i)).replace("{{image_url}}", encodeURIComponent(e)).replace("{{raw_image_url}}", e).replace("{{text}}", encodeURIComponent(n)) + '" target="_blank" class="pswp__share--' + t.id + '"' + (t.download ? "download" : "") + ">" + t.label + "</a>", g.parseShareButtonOut && (o = g.parseShareButtonOut(t, o));
        ...
        x.init = function () {
            ...
            d("destroy", function () {
                g.captionEl && (a && n.removeChild(a), e.removeClass(o, "pswp__caption--empty")),
        ...
        x.update = function () {
            k && t.currItem ? (x.updateIndexIndicator(), g.captionEl && (g.addCaptionHTMLFn(t.currItem, o), I(o, "caption--empty", !t.currItem.title)), w = !0) : w = !1,
            S || _(),
            P()
        },
        ...
        x.onGlobalTap = function (i) {
            ...
            if (!v)
                ...
                } else if (g.tapToToggleControls && (k ? x.hideControls() : x.showControls()), g.tapToClose && (e.hasClass(n, "pswp__img") || E(n)))
                    return void t.close()
        },
    ...
    for (var e = function (t) {
        ...
        if (a = function (t) {
            for (var e, i, n, o, a = t.childNodes, r = a.length, s = [], l = 0; l < r; l++)
                1 === (e = a[l])
                    .nodeType && (n = (i = e.children[0]).getAttribute("data-size").split("x"), o = {
        ...
        return this.each(function () {
            ...
            function p() {
                ...
                if (c < r) {
                    ...
                    i.stickyClass && e.removeClass(i.stickyClass), e.css({
                        position: "static",
                        top: null,
                        left: null,
                        width: "auto"
...
({
    ...
    4: [function (t, e, i) {
            ...
            o.prototype.eventElement = function (t) {
                ...
                return void 0 === e && (e = new n(t), this.eventElements.push(e)),
                e
            },
    ...
    6: [function (t, e, i) {
            ...
            function n(t) {
                return function (e, i) {
                    t(e, "ps--in-scrolling"),
                    void 0 !== i ? t(e, "ps--" + i) : (t(e, "ps--x"), t(e, "ps--y"))
                }
            }
            var o = t("./class"),
            a = t("./dom"),
            ...
            function n(t, e) {
                ...
                e.event.bind(window, "mousemove", function (e) {
                    if (u) {
                        ...
                        a.x < r.left + 3 ? (c.left = -5, o.startScrolling(t, "x")) : a.x > r.right - 3 ? (c.left = 5, o.startScrolling(t, "x")) : c.left = 0,
                        a.y < r.top + 3 ? (c.top = r.top + 3 - a.y < 5 ? -5 : -20, o.startScrolling(t, "y")) : a.y > r.bottom - 3 ? (c.top = a.y - r.bottom + 3 < 5 ? 5 : 20, o.startScrolling(t, "y")) : c.top = 0,
    ...
    19: [function (t, e, i) {
            ...
            e.exports = function (t) {
                ...
                !i.settings.suppressScrollX && i.containerWidth + i.settings.scrollXMarginOffset < i.contentWidth ? (i.scrollbarXActive = !0, i.railXWidth = i.containerWidth - i.railXMarginWidth, i.railXRatio = i.containerWidth / i.railXWidth, i.scrollbarXWidth = n(i, o.toInt(i.railXWidth * i.containerWidth / i.contentWidth)), i.scrollbarXLeft = o.toInt((i.negativeScrollAdjustment + t.scrollLeft) * (i.railXWidth - i.scrollbarXWidth) / (i.contentWidth - i.containerWidth))) : i.scrollbarXActive = !1,
                !i.settings.suppressScrollY && i.containerHeight + i.settings.scrollYMarginOffset < i.contentHeight ? (i.scrollbarYActive = !0, i.railYHeight = i.containerHeight - i.railYMarginHeight, i.railYRatio = i.containerHeight / i.railYHeight, i.scrollbarYHeight = n(i, o.toInt(i.railYHeight * i.containerHeight / i.contentHeight)), i.scrollbarYTop = o.toInt(t.scrollTop * (i.railYHeight - i.scrollbarYHeight) / (i.contentHeight - i.containerHeight))) : i.scrollbarYActive = !1,
                ...
                (t, i),
                i.scrollbarXActive ? a.add(t, "ps--active-x") : (a.remove(t, "ps--active-x"), i.scrollbarXWidth = 0, i.scrollbarXLeft = 0, l(t, "left", 0)),
                i.scrollbarYActive ? a.add(t, "ps--active-y") : (a.remove(t, "ps--active-y"), i.scrollbarYHeight = 0, i.scrollbarYTop = 0, l(t, "top", 0))
            }
        }, {
            "../lib/class": 2,
            "../lib/dom": 3,
    ...
    20: [function (t, e, i) {
            ...
            e.exports = function (t, e, i) {
                ...
                "top" === e && i <= 0 && (t.scrollTop = i = 0, t.dispatchEvent(o("ps-y-reach-start"))),
                "left" === e && i <= 0 && (t.scrollLeft = i = 0, t.dispatchEvent(o("ps-x-reach-start")));
                var a = n.get(t);
                "top" === e && i >= a.contentHeight - a.containerHeight && ((i = a.contentHeight - a.containerHeight) - t.scrollTop <= 1 ? i = t.scrollTop : t.scrollTop = i, t.dispatchEvent(o("ps-y-reach-end"))),
                "left" === e && i >= a.contentWidth - a.containerWidth && ((i = a.contentWidth - a.containerWidth) - t.scrollLeft <= 1 ? i = t.scrollLeft : t.scrollLeft = i, t.dispatchEvent(o("ps-x-reach-end"))),
                ...
                "top" === e && i !== a.lastTop && (t.scrollTop = a.lastTop = i, t.dispatchEvent(o("ps-scroll-y"))),
                "left" === e && i !== a.lastLeft && (t.scrollLeft = a.lastLeft = i, t.dispatchEvent(o("ps-scroll-x")))
            }
        }, {
            "./instances": 18
        }
    ...
    t.fn.materialChip = function (e) {
        ...
        "data" === e ? this.$el.data("chips") : "options" === e ? this.$el.data("options") : (this.$el.data("options", t.extend({}, this.defaultOptions, e)), this.init = (() => {
                this.$el.each((e, i) => {
                    ...
                    o.data && Array.isArray(o.data) || (o.data = []),
                    n.data("chips", o.data),
                    n.data("index", e),
                    n.data("initialized", !0),
                    n.hasClass(this.selectors.chips) || n.addClass("chips"),
                    this.renderChips(n)
                })
            ...
            this.$document.on("keydown", e => {
                if (t(e.target).is("input, textarea"))
                    return;
            ...
            this.$document.on("focusin", `${this.selectors.chips} ${this.selectors.input}`, e => {
                t(e.target).closest(this.selectors.chips).addClass("focus"),
                t(this.selectors.chip).removeClass("selected")
            }),
            ...
            this.$document.on("keydown", `${this.selectors.chips} ${this.selectors.input}`, e => {
                ...
                if (e.which === this.keyCodes.enter)
                    return e.preventDefault(), this.addChip(o, {
                        tag: i.val()
                    }, n), void i.val("");
            ...
            this.$document.on("click", `${this.selectors.chips} ${this.selectors.delete}`, e => {
                ...
                e.stopPropagation(),
                this.deleteChip(n.data("index"), o.index(), n),
                n.find("input").focus()
            })
                ...
                const o = i.index() + 1;
                t(this.selectors.chip).removeClass("selected"),
                o > n ? e.find("input").focus() : this.selectChip(e.data("index"), o, e)
            }), this.renderChips = (t => {
                let e = "";
            ...
            (function (t) {
                ...
                S = function () {
                    ...
                    return o(t, [{
                                ...
                                value: function () {
                                    ...
                                    !!this.image.$item || (null === this.image.src && (this.image.src = this.css(this.$item, "background-image").replace(/^url\(['"]?/g, "").replace(/['"]?\)$/g, "")), !(!this.image.src || "none" === this.image.src))
                                }
                            }, {
                                key: "canInitParallax",
                                value: function () {
                                ...
                                value: function () {
                                    if ("fixed" === this.image.position) {
                                        ...
                                        i = t.height;
                                        if (!this.$clipStyles)
                                            this.$clipStyles = document.createElement("style"), this.$clipStyles.setAttribute("type", "text/css"), this.$clipStyles.setAttribute("id", "jarallax-clip-" + this.instanceID), (document.head || document.getElementsByTagName("head")[0]).appendChild(this.$clipStyles);
                                ...
                                value: function () {
                                    ...
                                    a = e,
                                    r = 0;
                                    return n && (o = i < 0 ? i * Math.max(e, p) : i * (e + p), i > 1 ? a = Math.abs(o - p) : i < 0 ? a = o / i + Math.abs(o) : a += Math.abs(p - e) * (1 - i), o /= 2),
                ...
                C = function (t) {
                    ...
                    for (var e = arguments[1], i = Array.prototype.slice.call(arguments, 2), n = t.length, o = 0, r = void 0; o < n; o++)
                        if ("object" === (void 0 === e ? "undefined" : a(e)) || void 0 === e ? t[o].jarallax || (t[o].jarallax = new S(t[o], e)) : t[o].jarallax && (r = t[o].jarallax[e].apply(t[o].jarallax, i)), void 0 !== r)
                            return r;
                    return t
                };
                C.constructor = S,
...
([, , function (t, e, i) {
                            ...
                            value: function (t) {
                                ...
                                e.$video ? t(e.$video) : e.onAPIready(function () {
                                    ...
                                    if (e.$video || ((i = document.createElement("div")).style.display = "none"), "youtube" === e.type) {
                                        ...
                                        a && (e.$video = document.getElementById(e.playerID), e.videoWidth = parseInt(e.$video.getAttribute("width"), 10) || 1280, e.videoHeight = parseInt(e.$video.getAttribute("height"), 10) || 720)
                                    }
                                    if ("vimeo" === e.type) {
                                        e.playerOptions = "",
                                        ...
                                        e.$video || (e.$video = document.createElement("iframe"), e.$video.setAttribute("id", e.playerID), e.$video.setAttribute("src", "https://player.vimeo.com/video/" + e.videoID + "?" + e.playerOptions), e.$video.setAttribute("frameborder", "0"), i.appendChild(e.$video), document.body.appendChild(i)),
            ...
            e.default = function () {
                    ...
                    if (i.isValid())
                        if (e) {
                            if (i.on("ready", function () {
                                ...
                                }), t.video = i, !t.defaultInitImgResult)
                ...
                e.prototype.destroy = function () {
                    this.image.$default_item && (this.image.$item = this.image.$default_item, delete this.image.$default_item),
                    l.apply(this)
                }
            };
            var n = a(i(8)),
